...
#include<stdlib.h>
#include<unistd.h>
#include"def.h" //Définition des types de données du projet 
...
#define fonRECHERCHE rechercheDichotomique //Indiquer la fonction de recherche (rechercheSequentielle,rechercheDichotomique) <---
...
int main(){	
	...
	printf(" Pas d'incrémentation du nombre de ligne : %d\n", PAS);
